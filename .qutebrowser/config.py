...
## Type: QssColor
c.colors.completion.item.selected.bg = nord['cyan']

# Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = nord['cyan']

# Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = nord['cyan']
...
## Type: QssColor
c.colors.completion.scrollbar.bg = nord['base03']

# Color of the scrollbar handle in completion view.
## Type: QssColor
c.colors.completion.scrollbar.fg = nord['base0']
...
## Type: QssColor
c.colors.statusbar.caret.bg = nord['cyellow']

# Foreground color of the statusbar in caret mode.
## Type: QssColor
c.colors.statusbar.caret.fg = nord['black']
...
## Type: QssColor
c.colors.statusbar.caret.selection.fg = nord['black']
...
## Type: QssColor
c.colors.statusbar.insert.bg = nord['iblue']
...
## Type: QssColor
c.colors.statusbar.passthrough.bg = nord['cyellow']
...
## Type: QtColor
c.colors.tabs.selected.even.bg = nord['cyan']
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['cyan']

# Foreground color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.fg = nord['base3']

# Show/hide status & tab bar
...
c.fonts.prompts = "Menlo"
c.fonts.contextmenu = "Menlo"
c.fonts.downloads = "10pt Menlo"
c.fonts.debug_console = "10pt Menlo"
c.fonts.hints = "14pt Menlo"
c.fonts.keyhint = "14pt Menlo"
c.fonts.messages.error = "10pt Menlo"
c.fonts.messages.info = "10pt Menlo"
c.fonts.messages.warning = "10pt Menlo"
c.fonts.statusbar = "10pt Menlo"
...
c.tabs.padding = {'bottom': 5, 'left': 1, 'right': 1, 'top': 5}
